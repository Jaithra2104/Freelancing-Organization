          ...
          <div className="entity-graphic walker-graphic">
            <svg width="60" height="56" viewBox="0 0 60 56" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <g className="walker-stride-group">
                ...
                <path d="M30 19 L 30 25" stroke="#DC2626" strokeWidth="1.2" />
        ...
        <div className="speed-entity entity-bicycle">
          ...
          <div className="entity-graphic bicycle-graphic">
            <svg width="84" height="56" viewBox="0 0 84 56" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <circle cx="36" cy="10" r="4.5" fill="#0EA5E9" />
              <path d="M36 14.5 L 28 23 L 38 26" fill="#0284C7" />
              <path d="M36 14.5 L 51 20" stroke="#38BDF8" strokeWidth="2.8" strokeLinecap="round" />
          ...
          <div className="car-wrapper">
            ...
            <div className="entity-graphic car-graphic">
              <svg width="160" height="58" viewBox="0 0 160 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Rear Wheel — Spun in place around axle center (36, 45) */}
                <g className="wheel-rotate rear-wheel">
                ...
                {/* Front Wheel — Spun in place around axle center (120, 45) */}
                <g className="wheel-rotate front-wheel">
