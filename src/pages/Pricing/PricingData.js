export const pricingPlans = [
  ...
  },
  {
    ...
    price: '₹999',
    unit: '/ Hour',
    desc: 'Perfect for businesses that want customers to interact online.',
    popular: true,
    features: [
  ...
  },
  {
    ...
    price: '₹1299',
    unit: '/ Hour',
    desc: 'Ideal for businesses that want complete control over their website.',
    popular: false,
    features: [
  ...
  },
  {
    ...
    price: '₹1499',
    unit: '/ Hour',
    desc: 'Complete digital solution for growing businesses.',
    popular: false,
    features: [
