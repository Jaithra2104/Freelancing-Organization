...
export default function RefundPolicy() {
  ...
  return (
    <div className="legal-page-container">
      <SEO
        title="Refund Policy | VyuhaTech"
        description="VyuhaTech Refund Policy details clear eligibility, transparent review procedures, and client satisfaction guidelines."
